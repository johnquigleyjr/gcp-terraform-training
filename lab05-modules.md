...
```hcl
# Remove all of the resource blocks and resource block content:
#
# resource "google_compute_network" "vpc_network" {
# ...
# }
...
`main.tf` configuration, modify the public output to match the following. Notice the difference in interpolation now that the information is being delivered by a module.
...
# module.server.google_compute_instance.web will be created
+ resource "google_compute_instance" "web" {
